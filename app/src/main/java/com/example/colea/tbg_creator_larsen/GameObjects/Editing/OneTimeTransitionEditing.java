...
public class OneTimeTransitionEditing extends AppCompatActivity  implements PopupMenu.OnMenuItemClickListener, LifecycleObserver, View.OnClickListener {

    public static OneTimeTransition givenTransition;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_one_time_transition_editing);
        if(givenTransition != null)
        {
            ...
            transTitle.setText("One Time Transition " + givenTransition.getId());
        }
    }
    ...
    public void onSaveClick(View view)
    {
        ...
        OneTimeTransition x = givenTransition;
        if(x == null)
        {
            x = new OneTimeTransition(disVal, transVal);
        }
        //Set Everything
