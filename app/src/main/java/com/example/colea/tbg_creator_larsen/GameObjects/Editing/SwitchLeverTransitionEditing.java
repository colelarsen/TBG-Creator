...
public class SwitchLeverTransitionEditing extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, LifecycleObserver, View.OnClickListener  {

    public static SwitchLeverTransition givenTransition;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_switch_lever_transition_editing);
        if(givenTransition != null)
        {
            ...
            switchEdit.setText(givenTransition.switc);
            ...
            transTitle.setText("Switch Lever Transition " + givenTransition.getId());
        }
    }
    ...
    public void onSaveClick(View view)
    {
        ...
        SwitchLeverTransition x = givenTransition;
        if(x == null)
        {
            x = new SwitchLeverTransition(disVal, transVal, switchName);
        }
        //Set Everything
