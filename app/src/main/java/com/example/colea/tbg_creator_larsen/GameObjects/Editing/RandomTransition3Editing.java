...
public class RandomTransition3Editing extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, LifecycleObserver, View.OnClickListener {

    public static RandomTransitionType3 givenTransition;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random_transition3_editing);
        if(givenTransition != null)
        {
            ...
            if(givenTransition.goingTo != null) {
                stateEdit.setText(givenTransition.goingTo.uniqueUserId + "@" + givenTransition.goingTo.getId());
            }
            ...
            transTitle.setText("Random Transition Type 3 " + givenTransition.getId());
        }
    }
    ...
    public void onSaveClick(View view)
    {
        ...
        RandomTransitionType3 x = givenTransition;
        if(x == null)
        {
            if(transChans.size() == randomTrans.size() && transChans.size() > 0) {
                x = new RandomTransitionType3(disVal, randomTrans, transChans);
            }
            else
            {
                x = new RandomTransitionType3(disVal, randomTrans);
            }
        }
        else
        {
