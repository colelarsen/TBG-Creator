...
public class RandomTransition2Editing extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, LifecycleObserver, View.OnClickListener {

    static RandomTransitionType2 givenTransition;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_random_transition2_editing);
        ...
        if (givenTransition != null) {
            ...
            transTitle.setText("Random Transition Type 2 " + givenTransition.getId());
        }
    }
    ...
    public void onSaveClick(View view) {
        ...
        RandomTransitionType2 x = givenTransition;
        if (x == null) {
            if (transChans.size() == randomTrans.size() && transChans.size() > 0) {
                x = new RandomTransitionType2(randomTrans, transChans);
            } else {
                x = new RandomTransitionType2(randomTrans);
            }
        } else {
