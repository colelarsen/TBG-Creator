...
public class ConditionalHasSpellEditing extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, LifecycleObserver {

    public static HasSpell givenConditional = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conditional_has_spell_editing);
        if(givenConditional != null)
        {
            ...
            itemTitle.setText("Has Spell " + givenConditional.id);
        }
    }
    ...
    public void onSaveClick(View view)
    {
        ...
        HasSpell conditionalSwitch = givenConditional;
        ...
        if(givenConditional == null)
        {
            conditionalSwitch = new HasSpell();
        }
