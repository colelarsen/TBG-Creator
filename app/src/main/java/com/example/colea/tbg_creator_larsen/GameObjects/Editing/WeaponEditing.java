...
public class WeaponEditing extends AppCompatActivity implements LifecycleObserver {

    public static Weapon givenWeapon = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weapon_editing);
        ...
        if(givenWeapon != null)
        {
            ...
            damageValueEdit.setText("" + givenWeapon.attack);
            ...
            itemTitle.setText("Weapon " + givenWeapon.id);
        }
    }
    ...
    public void onSaveClick(View view)
    {
        ...
        {
            newItem.attack = Integer.parseInt(damageValueEdit.getText().toString());
        }
